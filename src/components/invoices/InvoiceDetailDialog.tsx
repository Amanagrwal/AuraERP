...
//             .invoice-header { display: flex; justify-content: space-between; margin-bottom: 40px; padding-bottom: 20px; border-bottom: 2px solid #1E4FFF; }
//             .company-info h1 { font-size: 24px; color: #1E4FFF; margin-bottom: 8px; }
//             .company-info p { font-size: 12px; color: #666; line-height: 1.6; }
//             .invoice-meta { text-align: right; }
//             .invoice-meta h2 { font-size: 32px; color: #1E4FFF; margin-bottom: 8px; }
//             .invoice-meta p { font-size: 12px; color: #666; }
//             .parties { display: flex; gap: 40px; margin-bottom: 30px; }
//             .party { flex: 1; }
//             .party h3 { font-size: 12px; color: #999; text-transform: uppercase; margin-bottom: 8px; }
...
//             .totals .grand-total { background: #1E4FFF; color: white; padding: 12px; margin-top: 8px; font-size: 18px; }
...
//       <h1>${invoice?.company?.company_name || 'Company'}</h1>
//       <p>
//         ${invoice?.company?.address || ''}<br>
//         GSTIN: ${invoice?.company?.gstin || 'N/A'}<br>
...
//             <div class="party">
//               <h3>Bill To</h3>
//               <p><strong>${invoice?.billing_name}</strong><br>
//               ${invoice?.customer?.billing_address || ''}<br>
//               ${invoice?.customer?.gstin ? `GSTIN: ${invoice?.customer?.gstin}` : ''}<br>
//               State: ${invoice?.customer?.state_of_supply?.state_name || ''}</p>
//             </div>
//           </div>
...
//                        ${taxHtml}        
//         <div class="row"><span>Round Amount</span><span>${invoice?.round_amt}</span></div>
//             <div class="grand-total row"><span>Grand Total</span><span>${amountInWords(invoice?.net_amt)}</span></div>
//             </div>
          
//         <div class="footer">
//   <div class="footer-row">

//     <!-- LEFT: Invoice Footer / Terms -->
//     <div class="footer-left">
//       ${invoice?.company?.invoice_footer ? `
//         <div class="invoice-footer-text">
//           ${invoice?.company?.invoice_footer.replace(/\n/g, "<br/>")}
//         </div>
//       ` : ''}
//     </div>
